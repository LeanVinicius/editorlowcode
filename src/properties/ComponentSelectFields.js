...
import { TooltipWithPortal } from "@/utils/TooltipWithPortal";
        ...
        <div className="flex flex-col space-y-5">
            <div className="flex flex-col space-y-3">
                <div className="flex flex-row space-x-1 items-center">
                    ...
                    <TooltipWithPortal content="Descreva a origem da fonte que alimentará as opções. Ex: Lista 'cidades' do site do Sharepoint 'Base de Dados'">
